...
public class Clarington_Map extends Activity {
	MapView map = null;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.clarington_map);
		
		map = (MapView)findViewById(R.id.clarington_mapview);
		...
		map.addLayer(new ArcGISDynamicMapServiceLayer("" + "https://extgis.cloca.com/extArcGIS/rest/services/Android/Clarington/MapServer"));
