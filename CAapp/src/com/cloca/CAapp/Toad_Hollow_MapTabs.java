...
public class Toad_Hollow_MapTabs extends TabActivity implements OnTabChangeListener{
...
@Override
	public void onCreate(Bundle savedInstanceState) {
		...
		_tabSpec = _tabHost.newTabSpec("map").setIndicator("MAP", _res.getDrawable(R.drawable.map)).setContent(new Intent(this,Toad_HollowMap.class));
