...
public class Long_Sault_MapTabs extends TabActivity implements OnTabChangeListener{
...
@Override
	public void onCreate(Bundle savedInstanceState) {
		...
		_tabSpec = _tabHost.newTabSpec("map").setIndicator("MAP", _res.getDrawable(R.drawable.map)).setContent(new Intent(this,Long_SaultMap.class));
		...
		_tabSpec = _tabHost.newTabSpec("directions").setIndicator("DIRECTIONS", _res.getDrawable(R.drawable.directions)).setContent(new Intent(this, Long_Sault_Directions.class));
		_tabHost.addTab(_tabSpec);
