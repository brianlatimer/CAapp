...
public class Oshawa_Map extends Activity {
	MapView map = null;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.oshawa_map);
		
		map = (MapView)findViewById(R.id.oshawa_mapview);
		...
		map.addLayer(new ArcGISDynamicMapServiceLayer("" + "https://extgis.cloca.com/extArcGIS/rest/services/Android/Oshawa/MapServer"));
