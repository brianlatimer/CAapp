...
public class Whitby_Map extends Activity {
	MapView map = null;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.whitby_map);
		
		map = (MapView)findViewById(R.id.whitby_mapview);
		...
		map.addLayer(new ArcGISDynamicMapServiceLayer("" + "https://extgis.cloca.com/extArcGIS/rest/services/Android/Whitby/MapServer"));
