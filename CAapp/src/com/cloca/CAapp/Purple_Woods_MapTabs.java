...
public class Purple_Woods_MapTabs extends TabActivity implements OnTabChangeListener{
...
@Override
	public void onCreate(Bundle savedInstanceState) {
		...
		_tabSpec = _tabHost.newTabSpec("map").setIndicator("MAP", _res.getDrawable(R.drawable.map)).setContent(new Intent(this,Purple_WoodsMap.class));
		...
		_tabSpec = _tabHost.newTabSpec("directions").setIndicator("DIRECTIONS", _res.getDrawable(R.drawable.directions)).setContent(new Intent(this, Purple_Woods_Directions.class));
		_tabHost.addTab(_tabSpec);
