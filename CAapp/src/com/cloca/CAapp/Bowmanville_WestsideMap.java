...
public class Bowmanville_WestsideMap extends Activity {
	MapView map = null;

	public void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		setContentView(R.layout.bowmanville_westside_map);
		
		map = (MapView)findViewById(R.id.bowmanville_westside_mapview);
