...
public class Scugog_Map extends Activity {
	MapView map = null;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.scugog_map);
		
		map = (MapView)findViewById(R.id.scugog_mapview);
		...
		map.addLayer(new ArcGISDynamicMapServiceLayer("" + "https://extgis.cloca.com/extArcGIS/rest/services/Android/Scugog/MapServer"));
